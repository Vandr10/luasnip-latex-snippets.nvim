...
function M.retrieve(is_math)
  ...
  return {
    ...
    parse_snippet({ trig = "-t>", name = "text arrow", priority = 200 }, "\\xrightarrow{$1}$0 "),
    ...
    parse_snippet({ trig = "bmat", name = "bmat" }, "\\begin{bmatrix} \n$1\n\\end{bmatrix} $0"),
    parse_snippet({ trig = "pmat", name = "pmat" }, "\\begin{pmatrix} \n$1\n\\end{pmatrix} $0"),
    parse_snippet({ trig = "mmat", name = "mmat" }, "\\begin{matrix} \n$1\n\\end{matrix} $0"),
